// Auto-generated from resources/templates/codegen/init_h.inja -- DO NOT EDIT
#pragma once
#include <string_view>

namespace rex::codegen::embedded {
inline constexpr std::string_view codegen_init_h = R"__TMPL__(// Generated by rexglue
...
{% include "codegen/_indirect_call.inja" %}
...
{% for fn in functions %}DECLARE_REX_FUNC({{ fn.name }});
{% endfor %}
)__TMPL__";
}  // namespace rex::codegen::embedded
