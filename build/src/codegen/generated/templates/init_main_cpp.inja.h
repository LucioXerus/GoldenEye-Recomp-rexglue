...
inline constexpr std::string_view init_main_cpp = R"__TMPL__(// {{ names.snake_case }} - ReXGlue Recompiled Project

#include "{{ entrypoint_out_dir }}/{{ names.snake_case }}_init.h"
